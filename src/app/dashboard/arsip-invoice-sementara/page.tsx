...
export default function ArsipInvoiceSementaraPage() {
  ...
  const [waItem, setWaItem] = useState<ArsipInvoiceSementara | null>(null);
  ...
  const handleWaClick = (item: ArsipInvoiceSementara) => {
    setWaItem(item);
    setWaStatus("");
        ...
        <div className="space-y-4">
          ...
          {waItem && (
            <div className="p-3 bg-gray-50 rounded-lg text-xs text-gray-700">
              ...
              <p className="mt-1">{waItem.nomorPI} Invoice Sementara telah terbit</p>
            </div>
          )}
          {waStatus && (
